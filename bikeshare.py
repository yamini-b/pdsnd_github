...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data!We have 3 city available for filtering')#more comprehensive prompt added for refactoring change number 2
